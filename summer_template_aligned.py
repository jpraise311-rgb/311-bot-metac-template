...
# Reuse searchers, model names, and helpers from main.py so we keep Firecrawl, AskNews, Linkup, Perplexity, models, and metrics
from main import (
    firecrawl_searcher,
    linkup_searcher,
    asknews_searcher,
    perplexity_sonar_searcher,
    perplexity_sonar_pro_searcher,
...
class SummerTemplateBot2026(ForecastBot):
    ...
    Aligned to the `main.py` runner: it reuses the same search providers and model names.

    Forecasting methodology and models/search providers are preserved.
    """
